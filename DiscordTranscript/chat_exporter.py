...
async def export(
    ...
    return (
        await Transcript(
            ...
            military_time=military_time if military_time is not None else True,
            fancy_times=fancy_times if fancy_times is not None else True,
            before=before,
            after=after,
            bot=bot,
...
async def raw_export(
    ...
    return (
        await Transcript(
            ...
            messages=messages,
            pytz_timezone=tz_info,
            military_time=military_time if military_time is not None else False,
            fancy_times=fancy_times if fancy_times is not None else True,
            before=None,
            after=None,
            bot=bot,
